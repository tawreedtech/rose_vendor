...
import 'package:rose_vendor/features/pos/domain/models/temporary_cart_for_customer_model.dart';
import 'package:rose_vendor/features/pos/domain/services/cart_service_interface.dart';
import 'package:rose_vendor/features/pos/screens/invoice_screen.dart';
import 'package:rose_vendor/features/pos/widgets/product_variation_selection_dialog_widget.dart';
...
class CartController extends ChangeNotifier{
  ...
  Future<void> scanProductBarCode(BuildContext context, [String? code]) async{
    String? scannedProductBarCode;
    try{
      scannedProductBarCode=code;
//  scannedProductBarCode = await FlutterScanner.scanBarcode(
//           lineColor: '#ff6666',
