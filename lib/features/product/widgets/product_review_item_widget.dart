...
import 'package:rose_vendor/common/basewidgets/rating_bar_widget.dart';
    ...
    return Padding(padding: const EdgeInsets.only(bottom: Dimensions.paddingSizeDefault),
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(color: Theme.of(context).primaryColor.withOpacity(0.10), offset: const Offset(0, 6), blurRadius: 15, spreadRadius: -3),
          ],
        ),
